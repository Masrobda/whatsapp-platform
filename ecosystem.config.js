module.exports = {
  apps: [
    ...
    // 11. WORKER SOCADEL CSV IMPORT
    {
      ...
      exec_mode: 'fork',
      autorestart: false,
      cron_restart: '0 */5 * * *', // S'exécute toutes les 5 heures
      env: {
        NODE_ENV: 'production',
        HOME: '/var/www/numericexport'
      }
  ...
  env: {
   ...
   // SOCADEL WORKER — sync batch (1 instance)
   {
  name: 'socadel-worker',
  cwd: '/var/www/numericexport/api',
  script: 'src/workers/socadel.worker.js',
  instances: 1,
  exec_mode: 'fork',
  autorestart: true,
  max_memory_restart: '500M',
  env: {
    ...
    HOME: '/var/www/numericexport'
      ...
      // CRON SOCADEL bordereau intellignent syn API toutes les 15 min
        {
      name: 'socadel-sync-cron',
      cwd: '/var/www/numericexport/api',
      script: 'src/workers/socadel-sync.cron.js',
      instances: 1,
      exec_mode: 'fork',
      autorestart: true,
    ...
    {
  name: 'bot-inactivity-cron',
  cwd: '/var/www/numericexport/api',
  script: 'src/workers/bot-inactivity.cron.js',
  instances: 1,
  exec_mode: 'fork',
  autorestart: true,
  max_memory_restart: '200M',
  env: { NODE_ENV: 'production', HOME: '/var/www/numericexport' }
},

{
  name: 'socadel-invoice-retry-cron',
  cwd: '/var/www/numericexport/api',
  script: 'src/workers/socadel-invoice-retry.cron.js',
  instances: 1,
  exec_mode: 'fork',
  autorestart: true,
  max_memory_restart: '400M',
  env: {
    NODE_ENV: 'production',
    HOME: '/var/www/numericexport',
    SOCADEL_INVOICE_RETRY_BATCH: '40',
    SOCADEL_INVOICE_RETRY_INTERVAL_MS: '300000',
  },
},
