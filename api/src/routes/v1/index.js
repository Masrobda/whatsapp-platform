...
const socadelRoutes = require('./socadel.routes')
const socadelAgentAuthRoutes = require('./socadel-agent-auth.routes');
const partenaireReleveurAuthRoutes = require('./socadel-releveur-auth.routes');
const socadelReportingAuthRoutes = require('./socadel-reporting-auth.routes');
...
async function v1Routes(fastify, opts) {
  ...
  fastify.register(socadelAgentAuthRoutes, { prefix: '/auth' });
  fastify.register(partenaireReleveurAuthRoutes , { prefix: '/auth' });
  fastify.register(socadelReportingAuthRoutes , { prefix: '/auth' });
  // ────────────────────────────────────────────────
  // Clients & profils
  // ────────────────────────────────────────────────
  ...
  fastify.register(socadelRoutes, { prefix: '/socadel' });
  // ────────────────────────────────────────────────
