...
async function botDashboardRoutes(fastify, opts) {
  ...
  fastify.get('/invoice-sends', adminOnly, botDashboardController.listInvoiceSends);
  fastify.get('/invoice-sends/stats', adminOnly, botDashboardController.getInvoiceSendStats);
  fastify.get('/invoice-sends/export', adminOnly, botDashboardController.exportInvoiceSends);
  // ────────────────────────────────────────────────────────────────
